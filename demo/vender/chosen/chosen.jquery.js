...
(function() {
  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    function Chosen(elmn,data) {
	 if(data&&data.width){
		 this.f_width = data.width;
     }
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        container_div.html('<a href="javascript:void(0)" class="chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /><a href="javascript:void(0);" style="padding:0 0 0 5px;font-size:20px;"><span class="icon-trash-o"></span></a></div><ul class="chzn-results"></ul></div>');
      }
      ...
      if (this.is_multiple) {
		...
		var del = this.search_container.find('a').first();
		var default_text = this.default_text;
		var form_field_jq = this.form_field_jq;
		del.click(function() {
			var txt = $(this).closest('.chzn-drop').prev().find('span').first();
			txt.text(default_text);
			form_field_jq.val(null);
