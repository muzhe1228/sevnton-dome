...
(function (b) {
    b.fn.fullpage = function (c) {
        ...
        function n(a, e) {
            var d = {}, f, h = a.position(), h = null !== h ? h.top : null, H = G(a), l = a.data("anchor"),
                g = a.index(".section"), p = a.find(".slide.active");
            if (p.length) {
                f = p.data("anchor");
                var q = p.index()
            }
        ...
        function u(a, e) {
            var d = e.position(), f = a.find(".slidesContainer").parent(), h = e.index(), g = a.closest(".section"),
                l = g.index(".section"), k = g.data("anchor"), p = g.find(".fullPage-slidesNav"), q = e.data("anchor");
            if (c.onSlideLeave) {
        ...
        b(document).on("touchmove", function (a) {
            if (c.autoScrolling && B) {
                ...
                if (!k && !s)if (E = a.touches[0].pageY, y = a.touches[0].pageX, e.find(".slides").length && Math.abs(x - y) > Math.abs(D -
        ...
        b(window).on("hashchange", function () {
            if (!C) {
                var a = window.location.hash.replace("#", "").split("/"), b = a[0], a = a[1],
                    c = "undefined" === typeof r, f = "undefined" === typeof r && "undefined" === typeof a;
        ...
        b(".section").on("click", ".controlArrow", function () {
            if (!s) {
                s = !0;
                var a = b(this).closest(".section").find(".slides"), c = a.find(".slide.active"), d = null,
