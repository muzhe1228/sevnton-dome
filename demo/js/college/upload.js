...
function Uploader(options) {
    ...
    var defaults = {
        ...
        fileExts: ['ASF','AVI','MKV','MP4','DVD','HlS','MOV','FLV'],
        /**
         * 获取初始化信息
        ...
        onUploaded: function(curFile) {
            logger.debug('File: ' + curFile.fileName + ' is uploaded.');
            // 将文件信息存入上传成功列表
        ...
        onAdd: function(curFile) {
            logger.debug(curFile.file.name + ': ' + curFile.fileSizeMb + ' MB');
        },
        /**
         * 无文件上传时的处理函数
         * @method noUploadFn
